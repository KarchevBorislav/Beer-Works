...
class BeerControllerTest {
    ...
    void testListBeers() throws Exception {
        given(beerService.beerList(any(), any() , any())).willReturn(beerServiceImpl.beerList(null, null, false));
    ...
    void getBeerById() throws Exception {
        BeerDTO testBeerDTO = beerServiceImpl.beerList(null, null, false).get(0);
    ...
    void testCreateBeer() throws Exception {
        ...
        given(beerService.saveNewBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.beerList(null, null, false).get(1));
