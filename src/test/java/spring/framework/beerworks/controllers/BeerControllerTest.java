...
class BeerControllerTest {
    ...
    void testListBeers() throws Exception {
        given(beerService.beerList(null, null)).willReturn(beerServiceImpl.beerList(null, null));
    ...
    void getBeerById() throws Exception {
        BeerDTO testBeerDTO = beerServiceImpl.beerList(null, null).get(0);
    ...
    void testCreateBeer() throws Exception {
        ...
        given(beerService.saveNewBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.beerList(null, null).get(1));
